 ...
 */
class TicketStatus extends ObjectBase {
	 ...
	 *
	 * @see TicketStatus::$staff_group_ids
	 *
	 * @apiField
	 * @var bool
	 */
	...
	protected function parseData($data) {
		...
		$this->type = $data['type'];
		$this->mark_as_resolved = Helper::assureBool($data['markasresolved']);
		$this->display_count = Helper::assureBool($data['displaycount']);
		$this->status_color = $data['statuscolor'];
		$this->status_bg_color = $data['statusbgcolor'];
		$this->reset_due_time = Helper::assureBool($data['resetduetime']);
		$this->trigger_survey = Helper::assureBool($data['triggersurvey']);
	...
	/**
	 * Fetches all ticket statuses from the server.
	 *
	 * @return ResultSet|TicketStatus[]
	 */
	...
	/**
	 * Fetches ticket status from the server by its identifier.
	 *
	 * @param int $id Ticket status identifier.
	 * @return TicketStatus
	 */
