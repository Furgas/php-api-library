 ...
 */
class CustomFieldOption extends ObjectBase {
	...
	/**
	 * Fetches all options for specified custom field from the server.
	 *
	 * @param int $custom_field_id Custom field identifier.
	 * @return ResultSet|CustomFieldOption[]
	 */
	static public function getAll($custom_field_id) {
		return parent::genericGetAll(array($custom_field_id));
	}
