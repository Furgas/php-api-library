 ...
 */
class CustomFieldDefinition extends ObjectBase {
	 ...
	 *
	 * @var ResultSet|CustomFieldDefinition[]
	 */
	 ...
	 * Caches the result - call CustomFieldDefinition::clearCache() to clear the cache.
	 *
	 * @return ResultSet|CustomFieldDefinition[]
	 */
	static public function getAll() {
		if (self::$definitions === null) {
			self::$definitions = parent::genericGetAll();
		}
	...
	/**
	 * Returns field type (one of self::TYPE constants).
	 *
	 * @return int
	 * @filterBy
	 * @orderBy
	...
	public function getDefaultValue() {
		switch ($this->type) {
			...
			case self::TYPE_DATE:
				return date(Config::get()->getDateFormat(), $this->default_value);
				break;
	...
	public function getOptions($reload = false) {
		...
		switch ($this->type) {
			...
			case self::TYPE_SELECT:
				$this->options = CustomFieldOption::getAll($this->getId(true));
				break;
			default:
				$this->options = new ResultSet(array(), 'CustomFieldOption');
		}
	...
	public function getDefaultOptions() {
		switch ($this->type) {
			...
			default:
				return new ResultSet(array(), 'CustomFieldOption');
		}
	}
}